...
/////////////////////////////////////////////////////////////////
//// MODELO 303 /////////////////////////////////////////////////
class modelo303 extends modelos /** %from: modelos */ {
...
/////////////////////////////////////////////////////////////////
//// MODELO 340 /////////////////////////////////////////////////
class modelo340 extends modelo303 /** %from: modelos */
{
  ...
  function configurarBotonModelos() {
	...
	function clave340CriterioCaja(cursor) {
		return this.ctx.modelo340_clave340CriterioCaja(cursor);
	}
}
//// MODELO 340 /////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
//// DTO ESPECIAL ///////////////////////////////////////////////
class dtoEspecial extends modelo340 /** %from: oficial */
{
    function dtoEspecial( context ) { modelo340 ( context ); }
	function commonCalculateField(fN:String, cursor:FLSqlCursor):String {
...
function modelo340_calculaClave340(cursor)
{
	...
	valor = _i.clave340CriterioCaja(cursor);
	if (valor != "") {
		return valor;
	}
...
function modelo340_clave340CriterioCaja(cursor)
{
	var _i = this.iface;
	var valor = "";
	var critCajaProv = AQUtil.sqlSelect("proveedores", "criteriocaja", "codproveedor = '" + cursor.valueBuffer("codproveedor") + "' ");

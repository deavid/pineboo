...
class FLTableMetaData():
    ...
    """
    #typedef QDict<FLFieldMetaData> FLFieldMetaDataList;#FIXME
    ...
    """
    @decorators.NotImplementedWarn
    def fieldList(self, prefixTable):
...
class FLTableMetaDataPrivate():
    ...
    """
    @decorators.NotImplementedWarn
    def addFieldName(self, QtCore.QString n):
    ...
    """
    @decorators.NotImplementedWarn
    def removeFieldName(self, QtCore.QString n):
    ...
    Nombre de la tabla
    """
    QtCore.QString name_ = None

    """
    Alias de la tabla
    """
    QtCore.QString alias_ = None

    """
    Lista de campos que tiene esta tabla
    """
    @decorators.NotImplementedWarn
    FLFieldMetaDataList fieldList_ = None
    ...
    Lista de nombres de campos de la tabla que son del tipo FLFieldMetaData::Unlock
    """
    QtCore.QStringList fieldsNamesUnlock_ = None

    """
    Clave primaria
    """
    QtCore.QString primaryKey_= None
    """

...
/////////////////////////////////////////////////////////////////
//// DIAS_PAGO_PROV /////////////////////////////////////////////
class diasPagoProv extends recibosProv /** %from: oficial */ {
    function diasPagoProv( context ) { recibosProv ( context ); }
	function validateForm():Boolean {
...
/////////////////////////////////////////////////////////////////
//// ENVIO MAIL /////////////////////////////////////////////////
class envioMail extends diasPagoProv /** %from: oficial */ {
    function envioMail( context ) { diasPagoProv ( context ); }
    function init() {

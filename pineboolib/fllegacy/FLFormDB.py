...
class FLFormDB(QtGui.QWidget):
    ...
    def setCursor(self, *c):
        ...
        if self.cursor_:
            self.cursor_.destroyed(QtCore.QObject).disconnect(self.cursorDestroyed(QtCore.QObject))
        
        self.cursor_ = c 
        self.cursor_.destroyed(QtCore.QObject).connect(self.cursorDestroyed(QtCore.QObject))

...
class FLLineEdit(QtWidgets.QLineEdit):
    ...
    def setText(self, texto, b=True):
        ...
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setText" % self._parent.objectName(), texto)
...
class FLPixmapView(QtWidgets.QWidget):
    ...
    def setPixmap(self, pix):
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setPixmap" % self._parent.objectName(), self._parent.cursor_.valueBuffer(self._parent.fieldName_))
            return
...
class FLDateEdit(QtWidgets.QDateEdit):
    ...
    def setDate(self, d=None):
        ...
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setDate" % self._parent.objectName(), date.toString())
        else:
...
class FLTimeEdit(QtWidgets.QTimeEdit):
    ...
    def setTime(self, v):
        ...
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setTime" % self._parent.objectName(), date.toString())
...
class QComboBox(QtWidgets.QComboBox):
    ...
    def setCurrentIndex(self, n):
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setCurrentIndex" % self._parent.objectName(), n)
        super(QComboBox, self).setCurrentIndex(n)

    def setCurrentText(self, t):
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setCurrentText" % self._parent.objectName(), t)
...
class QLineEdit(QtWidgets.QLineEdit):
    ...
    def setText(self, text):
        ...
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setText" % self._parent.objectName(), t)
...
class QTextEdit(QtWidgets.QTextEdit):
    ...
    def setText(self, text):
        ...
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setText" % self._parent.objectName(), text)
...
class QCheckBox(QtWidgets.QCheckBox):
    ...
    def setChecked(self, b):
        ...
        if not pineboolib.project._DGI.localDesktop():
            pineboolib.project._DGI._par.addQueue("%s_setChecked" % self._parent.objectName(), b)

...
from pineboolib.fllegacy.FLForm import FLForm
...
class FLAccessControlMainWindow():
  ...
  en caso contrario devuelve una cadena vacía.
    ...
    def processObject(self, obj):
        ...
        for i in range(len(it.current())): #for (; it.current(); ++it) { #FIXME
    ...
    def setFromObject(self, object):
        print("FLAccessControlMainWindow::setFromObject %s" %   FLUtil.translate("app","No implementado todavía."))
...
class FLAccessControlForm():
  ...
  FLFormRecordDB y FLFormSearchDB) se pueda hacer no visible o no editable a conveniencia.
    ...
    def processObject(self, obj):
        ...
        for i in range(it.current()): #for (; it.current(); ++it) #FIXME
    ...
    @decorators.BetaImplementation
    def setFromObject(self, object):
        print("FLAccessControlform::setFromObject %s" % FLUtil.translate("app","No implementado todavía."))
